...
def save_benchmark_results_json(
    ...
    """
    Save benchmark results and node sizes to a JSON file.
    ...
    Args:
        ...
        node_sizes: Sequence or NumPy array of node sizes used for the benchmark.
        edge_ratio: Sequence or NumPy array of edge ratio used for the benchmark.
    ...
    try:
        ...
        payload = {
            ...
            "node_sizes": _to_builtin_python(node_sizes),
            "edge_ratios": _to_builtin_python(edge_ratios),
